...
props.ContinueStatement = ['label']

props.ImportDefaultSpecifier =
props.ImportNamespaceSpecifier = ['local']

props.ArrayPattern =
props.ArrayExpression = ['elements']
...
props.UpdateExpression = ['argument']

props.NewExpression =
props.CallExpression = ['callee', 'arguments']

props.WhileStatement =
props.DoWhileStatement = ['test', 'body']

props.Property =
props.MethodDefinition = ['key', 'value']

props.BinaryExpression =
props.AssignmentPattern =
props.LogicalExpression =
props.AssignmentExpression = ['left', 'right']

props.ForInStatement =
props.ForOfStatement = ['left', 'right', 'body']

props.FunctionExpression =
props.FunctionDeclaration =
props.ArrowFunctionExpression = ['id', 'params', 'body']

props.ClassExpression =
props.ClassDeclaration = ['id', 'superClass', 'body']

props.IfStatement =
props.ConditionalExpression = ['test', 'consequent', 'alternate']
