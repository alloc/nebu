...
var AcornMixin, acorn, createMixin, getArray, greedyRange, indent, isLiteral, noop, parseDepth, pt, stack, stripIndent;
...
AcornMixin.apply = function(output, walker) {
  var key, mixin, prev;
...
AcornMixin.remove = function(mixin) {
  var key, prev;
  prev = stack.pop();
  if (prev) {
    for (key in prev) {
