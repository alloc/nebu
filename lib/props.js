...
props.RestElement = props.SpreadElement = props.ThrowStatement = props.AwaitExpression = props.ReturnStatement = props.UnaryExpression = props.YieldExpression = props.UpdateExpression = ['argument'];
...
props.BinaryExpression = props.AssignmentPattern = props.LogicalExpression = props.AssignmentExpression = ['left', 'right'];

props.ForInStatement = props.ForOfStatement = ['left', 'right', 'body'];

props.FunctionExpression = props.FunctionDeclaration = props.ArrowFunctionExpression = ['id', 'params', 'body'];

props.ClassExpression = props.ClassDeclaration = ['id', 'superClass', 'body'];

props.IfStatement = props.ConditionalExpression = ['test', 'consequent', 'alternate'];
